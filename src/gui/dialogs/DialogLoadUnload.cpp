...
DialogLoadUnload::DialogLoadUnload(fsm::BaseData data)
    ...
    , progress_bar(&progress_frame, get_progress_bar_rect(GetRect()), COLOR_BRAND, GuiDefaults::EnableDialogBigLayout ? COLOR_DARK_GRAY : COLOR_GRAY, PROGRESS_BAR_CORNER_RADIUS)
