 ...
 */
 ...
 namespace move_only_inplace_function_detail {
 ...
 struct is_valid_inplace_dst : std::true_type
 {
     static_assert(DstCap >= SrcCap,
         "Can't squeeze larger move_only_inplace_function into a smaller one"
     );
 
     static_assert(DstAlign % SrcAlign == 0,
         "Incompatible move_only_inplace_function alignments"
     );
 };
 ...
 template<
     class Signature,
     size_t Capacity = move_only_inplace_function_detail::InplaceFunctionDefaultCapacity,
     size_t Alignment = alignof(move_only_inplace_function_detail::aligned_storage_t<Capacity>)
 >
 class move_only_inplace_function; // unspecified
 
 namespace move_only_inplace_function_detail {
     template<class> struct is_inplace_function : std::false_type {};
     template<class Sig, size_t Cap, size_t Align>
     struct is_inplace_function<move_only_inplace_function<Sig, Cap, Align>> : std::true_type {};
 } // namespace move_only_inplace_function_detail
 ...
 template<
     ...
     size_t Alignment
 >
 class move_only_inplace_function<R(Args...), Capacity, Alignment>
 {
     using storage_t = move_only_inplace_function_detail::aligned_storage_t<Capacity, Alignment>;
     using vtable_t = move_only_inplace_function_detail::vtable<R, Args...>;
     using vtable_ptr_t = const vtable_t*;
 
     template <class, size_t, size_t> friend class move_only_inplace_function;
 
 public:
     using capacity = std::integral_constant<size_t, Capacity>;
     using alignment = std::integral_constant<size_t, Alignment>;
 
     move_only_inplace_function() noexcept :
         vtable_ptr_{std::addressof(move_only_inplace_function_detail::empty_vtable<R, Args...>)}
     {}
     ...
     template<
         ...
         class = std::enable_if_t<
             !move_only_inplace_function_detail::is_inplace_function<C>::value
             && move_only_inplace_function_detail::is_invocable_r<R, C&, Args...>::value
         >
     >
     move_only_inplace_function(T&& closure)
     {
         static_assert(std::is_move_constructible<C>::value,
             "move_only_inplace_function cannot be constructed from non-movable type"
         );
 
         static_assert(sizeof(C) <= Capacity,
             "move_only_inplace_function cannot be constructed from object with this (large) size"
         );
 
         static_assert(Alignment % alignof(C) == 0,
             "move_only_inplace_function cannot be constructed from object with this (large) alignment"
         );
 
         static const vtable_t vt{move_only_inplace_function_detail::wrapper<C>{}};
     ...
     move_only_inplace_function(const move_only_inplace_function<R(Args...), Cap, Align>& other) = delete;
 
     template<size_t Cap, size_t Align>
     move_only_inplace_function(move_only_inplace_function<R(Args...), Cap, Align>&& other) noexcept
         : move_only_inplace_function(other.vtable_ptr_, other.vtable_ptr_->relocate_ptr, std::addressof(other.storage_))
     {
         static_assert(move_only_inplace_function_detail::is_valid_inplace_dst<
             Capacity, Alignment, Cap, Align
         >::value, "conversion not allowed");
 
         other.vtable_ptr_ = std::addressof(move_only_inplace_function_detail::empty_vtable<R, Args...>);
     }
 
     move_only_inplace_function(std::nullptr_t) noexcept :
         vtable_ptr_{std::addressof(move_only_inplace_function_detail::empty_vtable<R, Args...>)}
     {}
 
     move_only_inplace_function(const move_only_inplace_function& other) = delete;
 
     move_only_inplace_function(move_only_inplace_function&& other) noexcept :
         vtable_ptr_{std::exchange(other.vtable_ptr_, std::addressof(move_only_inplace_function_detail::empty_vtable<R, Args...>))}
     {
     ...
     move_only_inplace_function& operator= (std::nullptr_t) noexcept
     {
     ...
     move_only_inplace_function& operator= (move_only_inplace_function other) noexcept
     {
         vtable_ptr_->destructor_ptr(std::addressof(storage_));
     ...
     {
         return vtable_ptr_ != std::addressof(move_only_inplace_function_detail::empty_vtable<R, Args...>);
     }
 
     void swap(move_only_inplace_function& other) noexcept
     {
