...
dependencies = {
    ...
    'firmware-coreonel_ac_controller': {
        'version': '0.0.6',
        'url': 'https://prusa-buddy-firmware-dependencies.s3.eu-central-1.amazonaws.com/firmware-coreonel_ac_controller-0.0.6-3FD2B67B-3FA0-4BBB-BB24-A61E49BCAD39.zip',
    },
    'firmware-mmu': {
        'version': '3.0.4',
        'files': [
