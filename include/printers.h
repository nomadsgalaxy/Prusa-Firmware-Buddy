...
#define PRINTER_IS_PRUSA_COREONEL()   (PRINTER_TYPE == 8 && PRINTER_VERSION == 1 && PRINTER_SUBVERSION == 0)
// SIGNATURE_OAK() is defined by include/option/signature_oak.h (generated by define_boolean_option)
