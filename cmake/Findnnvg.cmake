# Find nnvg and setup python environment to generate C++ from DSDL. Copyright 2021 Amazon.com, Inc.
# or its affiliates. All Rights Reserved. Copyright 2021 OpenCyphal <consortium@opencyphal.org> This
# file is adapted from:
# https://github.com/OpenCyphal/nunavut/blob/main/verification/cmake/modules/Findnnvg.cmake
...
function(
  ...
  # Asserts take too much flash, it should not fail on cortex-m4
  #
  ...
  execute_process(
    COMMAND ${NNVG} --list-outputs ${NNVG_CMD_ARGS}
  ...
  if(NOT LIST_OUTPUTS_RESULT EQUAL 0)
    message(
      FATAL_ERROR
        "Failed to retrieve a list of headers nnvg would "
        "generate for the ${ARG_TARGET_NAME} target (${LIST_OUTPUTS_RESULT})" " (${NNVG})"
      )
  endif()

  execute_process(
    COMMAND ${NNVG} --list-inputs ${NNVG_CMD_ARGS}
  ...
  if(NOT LIST_INPUTS_RESULT EQUAL 0)
    message(FATAL_ERROR "Failed to resolve inputs using nnvg for the ${ARG_TARGET_NAME} "
                        "target (${LIST_INPUTS_RESULT})" " (${NNVG})"
            )
  endif()
  ...
  add_custom_target(${ARG_TARGET_NAME}-gen DEPENDS ${OUTPUT_FILES})
...
if(NNVG)
  ...
  message(FATAL_ERROR "Nnvg not found. Please install nunavut by pip")
endif()
